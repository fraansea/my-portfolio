...
export const Hero: React.FC = () => {
  return (
    <section className="flex flex-col items-center text-center">
      ...
      />
      <h1 className="text-black text-[42px] font-semibold leading-[46px] tracking-[-1.26px] mt-8 max-md:max-w-full">
        Hey, I'm Francis. <br />
        UI developer& Designer
      </h1>
      <p className="text-[rgba(90,90,90,1)] text-base font-normal leading-[22px] tracking-[0.16px] mt-5 max-md:max-w-full">
      ...
      <div className="flex w-[421px] max-w-full items-stretch gap-3 font-medium tracking-[-0.32px] mt-[26px] flex-wrap">
        <button className="bg-[rgba(25,25,25,1)] text-[15px] text-white leading-none px-9 py-[18px] rounded-[14px] max-md:px-5 hover:bg-[rgba(25,25,25,0.9)] transition-colors">
          Download Me
        </button>
        <div className="bg-[rgba(225,249,220,1)] flex items-stretch gap-1.5 text-base text-[rgba(23,141,0,1)] leading-none px-5 py-[15px] rounded-[100px]">
          <img
