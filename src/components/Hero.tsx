...
export const Hero: React.FC = () => {
  return (
    <section className="flex flex-col items-center text-center px-4 sm:px-8" data-aos="fade-up">
      ...
      <p className="text-[rgba(90,90,90,1)] text-base font-normal font-manrope leading-[22px] tracking-[0.16px] mt-5 max-md:max-w-full max-sm:text-sm">
      ...
      <div className="w-full max-w-6xl mt-16 px-2 sm:px-0">
        {(() => {
            ...
            <Carousel opts={carouselOptions} plugins={[autoScrollPlugin]} className="mx-auto">
              <CarouselContent>
                {[
                  ...
                  <CarouselItem key={i} className="flex justify-center px-2 min-w-[220px] max-w-[350px] sm:min-w-[350px] sm:max-w-[420px]">
                    <div
                      className="bg-neutral-50 overflow-hidden rounded-[20px] border border-[rgba(242,242,242,1)] border-solid flex items-center justify-center p-2 sm:p-4"
                      style={{ width: '100%', height: 180, minWidth: 0, minHeight: 120, maxWidth: 420 }}
                    >
                      <img
                        src={src}
                        alt={`Project ${i + 1}`}
